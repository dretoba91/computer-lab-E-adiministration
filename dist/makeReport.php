...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Lab E-Administration</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <tr>
                                    <td><input type="submit" name="lab_detail" value="Check Lab Items"></td>
                                </tr>
                                <tr>
                ...
                <main>
                    ...
                    <?php 
                                ...
                                if(isset($_POST['add'])) {
                                    ...
                                    $r_department = $_POST['departments'];

                                    // To prevent SQL Injection
                                    $r_name = mysqli_real_escape_string($conn, $r_name);
                                    $r_comment = mysqli_real_escape_string($conn, $r_comment);
                                    $r_department = mysqli_real_escape_string($conn, $r_department);
                                    // var_dump(mysqli_query($conn, $r_name));
                                    //      die();

                                     // Inserting Datas into the database
                                     $sql = "INSERT INTO feedback (uname, comment, departments) VALUES ('$r_name', '$r_comment', '$r_department')";
                                    //  var_dump($sql);
                                    //  die();
                        ...
                        <table width = "600" border = "0" cellspacing = "1" cellpadding = "2" class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <td width = "250">Report</td>
                                    <td><textarea name="comment" id="" cols="15" rows="5"></textarea></td>
                                </tr>
                                ...
                                <tr>
                                    <td width = "250"> </td>
                                    <td><input name = "add" type = "submit" id = "add"  value = "Send Report"></td>
                                </tr>
