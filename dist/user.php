                        ...
                        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">   
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-md-2" align="right" style="margin-bottom: 10px;">
                                        <button type="button" name="add" class="btn btn-success btn-xs" onclick="openForm()" >Add User</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table id="userList" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <!-- <td><?php $type = ($row['type'] == 1) ? 'Instructor' : 'Student'; echo $type; ?></td> -->
                                    <td><?php $type = ""; 
                                    if($row['type'] == 1) {
                                        echo "Instructor";
                                    } elseif ($row['type'] == 2) {
                                    ...
                                    <td>
                                        ...
                                        <!-- <a href="edit.php?edit=<?php echo $row['id']; ?>" class="edit_btn" onclick="openForm()" >Edit</a> -->
            ...
            <div class="sidebar-form">
                ...
                <?php 
                    ...
                    if(isset($_POST['save'])) {
                        ...
                        $sql = "INSERT INTO user (name, username, password, type) VALUES ('$name', '$username', '$password', '$usertype')";
