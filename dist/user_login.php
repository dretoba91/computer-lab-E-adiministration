<?php 
  ...
  if(isset($_POST['user_login']))
  {
        ...
        if($count > 0){
            ...
            //         header('loaction: instructor_home.php');
            //         break;
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="home-info">
                            <div class="card-header"><h3 class="text-center font-weight-heavy my-10" style="font-size: 30px;">Instructor/Student Login</h3></div>
                                <div class="">
                                    <form id="form1" name="form1" method="POST" action="" class="border border-info p-5">
                                            <div class="form-floating lg">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="username" name="username" style="width: 300px; font-size: 20px;" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="index.php" style="font-size: 15px;">Administrator Login</a>
                                                <!-- <button class="btn btn-primary btn-block" name="b1" >Log in</button> -->
                                                
                                                <label>
                                                <input type="submit" name="user_login" id="button" value="Login" style="width: 100px; font-size: 20px;" />
                                                </label>
